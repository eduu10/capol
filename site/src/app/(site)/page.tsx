        ...
        >
          {heroSlides.map((slide, index) => (
            <div key={index} className="relative min-w-full">
              <div className="relative h-[160px] sm:h-[400px] md:h-[600px] lg:h-[744px]">
                <Image
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-12">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-center gap-2 mt-4 md:mt-0">
              <Link href="/produtos" className="px-5 py-2 rounded-full text-sm font-semibold transition-colors whitespace-nowrap flex-shrink-0 cursor-pointer text-center text-white" style={{ backgroundColor: pc }}>Todos</Link>
