...
const defaultConfig: SiteConfig = {
  ...
  homeGalleryImages: [
    { src: '/imagens/galeria-capas/capol-cafes.jpg', alt: 'Capol Cafés' },
    { src: '/imagens/galeria-capas/capol-sao-francisco.jpg', alt: 'Capol São Francisco de Paula' },
    { src: '/imagens/galeria-capas/capol-oliveira-sede.jpg', alt: 'Sede Oliveira' },
  ],
