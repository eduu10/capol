...
const contacts = [
  ...
  },
  {
    label: 'CAPOL CAFÉS',
    number: '553799620986',
    message: 'Olá Capol Cafés! Vim pelo site e gostaria de saber sobre os produtos.',
  },
  {
    label: 'LOJA | FÁBRICA DE RAÇÃO',
    number: '553798516781',
    message: 'Olá! Vim pelo site da Capol e gostaria de fazer um pedido.',
  },
];
...
export default function WhatsAppFloat() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // Detect direction change — reset accumulator
      ...
      // Need 60px of consistent scroll in one direction to trigger
  ...
  return (
    <div className="fixed left-0 bottom-24 z-50 flex flex-col gap-3">
      {contacts.map((contact, index) => {
        ...
        const delay = collapsed ? index * 80 : (contacts.length - 1 - index) * 80;
        ...
        return (
          <a
            ...
            className="group flex items-center rounded-r-full bg-[#25d366] text-white shadow-lg hover:shadow-xl gap-3 py-3 pl-5 pr-6"
            style={{
              fontFamily: 'Raleway, sans-serif',
              transition: `all 0.4s cubic-bezier(0.4, 0, 0.2, 1) ${delay}ms`,
              ...( collapsed ? { gap: 0, paddingTop: 8, paddingBottom: 8, paddingLeft: 12, paddingRight: 12 } : {}),
            }}
          >
            ...
            <span
              className={`text-sm font-bold whitespace-nowrap overflow-hidden transition-all duration-400 ${
                collapsed
