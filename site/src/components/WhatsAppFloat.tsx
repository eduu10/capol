      ...
      {contacts.map((contact) => {
        ...
        return (
          <a
            ...
            className={`flex items-center rounded-l-full bg-[#25d366] text-white shadow-lg transition-all duration-300 ease-in-out hover:-translate-x-1 ${
              collapsed
          ...
          >
            ...
            <span
              className={`text-sm font-bold whitespace-nowrap transition-all duration-300 ${
                collapsed
                  ? 'w-0 opacity-0 overflow-hidden md:w-auto md:opacity-100'
                  : 'w-auto opacity-100'
              }`}
            >
              {contact.label}
