    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          >
            {/* Header */}
            <div className="bg-[#2e7d32] px-6 py-4 flex items-center justify-between">
            ...
            <div className="p-6">
              <p className="text-gray-600 text-sm mb-4">
                Escolha com quem deseja falar sobre o produto <strong>{productName}</strong>:
              </p>
              ...
              <div className="flex flex-col gap-3">
                {contacts.map((contact) => (
                  <a
                    ...
                    className="flex items-center gap-3 rounded-full bg-[#25d366] py-3 px-5 text-white font-bold text-sm shadow-md hover:bg-[#1da851] transition-colors hover:shadow-lg"
                  >
