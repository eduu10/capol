...
export default function Footer() {
  return (
    <footer>
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div>
              ...
              <div className="mb-4 h-[3px] w-12 bg-green-600" />
              <p className="mb-4 text-sm text-gray-600 leading-relaxed">
                Confira nosso horário de funcionamento e nos faça uma visita.
              </p>
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-center gap-2">
                  <span className="inline-block h-2.5 w-2.5 rounded-full bg-green-500" />
                  <span>Segunda-Sexta: 7:00 - 18:00</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="inline-block h-2.5 w-2.5 rounded-full bg-green-500" />
                  <span>Sábado: 7:00 - 12:00</span>
                </li>
                <li className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="mb-4 h-[3px] w-12 bg-green-600" />
              <p className="mb-4 text-sm text-gray-600 leading-relaxed">
                Venha nos visitar ou entre em contato conosco. Estamos prontos para atendê-lo.
              </p>
              <Link
                href="/contato"
                className="inline-flex items-center gap-2 rounded bg-green-600 px-5 py-2.5 text-sm font-bold text-white uppercase tracking-wide transition-colors hover:bg-green-700"
              >
      ...
      {/* Dark Green Section */}
      <div className="bg-[#2e7d32] py-10 text-white text-center">
        <div className="mx-auto max-w-7xl px-4">
          {/* Instagram */}
          <h3
          ...
          <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center sm:gap-6">
            ...
            <div className="flex items-center gap-3">
              <a
                href="https://facebook.com/capololiveira"
                target="_blank"
              ...
              <a
                href="https://instagram.com/capol_oliveira"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white/20 text-white transition-colors hover:bg-white/30"
